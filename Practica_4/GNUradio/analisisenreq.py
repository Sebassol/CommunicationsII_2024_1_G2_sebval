...
import analisisenreq_epy_block_0_0 as epy_block_0_0  # embedded python block
import math
import numpy as np
import sip
...
class analisisenreq(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "analisisenfreq", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("analisisenfreq")
        ...
        self.settings = Qt.QSettings("GNU Radio", "analisisenreq")
...
def main(top_block_cls=analisisenreq, options=None):
